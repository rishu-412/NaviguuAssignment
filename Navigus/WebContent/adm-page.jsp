...
<html>
<head>
	<title>NAVIGUS| Teacher Portal</title>
	<link rel="stylesheet" type="text/css" href="style-backend.css">
</head>
<body>
	<div class="top-area">
		<center><h2>Teacher's Account</h2></center>
		<div style="background:red; height:5px; width:100%;"></div>
		<a href="controller.jsp?page=logout" class="button" style="float: right;background:red;color:white; padding:15px;">Logout</a>
